...
public class wikiSegregate
{

    public ArrayList<String> get_categories (String arg) throws java.lang.Exception {
    ...
    public String get_cats(String inp) throws Exception{
        try
        {
            // String t = "singular_point";
            String command = "mapWikiCat.py";
            ProcessBuilder pb = new ProcessBuilder(Arrays.asList("/home/manjeet/anaconda2/bin/python2.7", command, inp));
    ...
    public String map_categories(ArrayList<String> head_cats , ArrayList<String> ent_cats){
        String cats_matches = "";
        int flag = 0;
